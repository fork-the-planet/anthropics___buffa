...
::buffa::impl_default_instance!(FieldMask);
#[cfg(feature = "reflect")]
const _: () = {
    impl ::buffa_descriptor::reflect::ReflectMessage for FieldMask {
    ...
    impl ::buffa_descriptor::reflect::ReflectElement for FieldMask {
        #[inline]
    ...
    impl ::buffa_descriptor::reflect::Reflectable for FieldMask {
